...
const DescriptionSection = () => {
  return (
    <div className="mt-6 p-4 bg-white shadow-lg rounded-lg mx-1">
      ...
      <p className="text-[16px]">
        Trước khi chúng ta bắt đầu khảo sát, mình sẽ giúp bạn hiểu rõ hơn về hai
        loại thần tượng ảo đang được quan tâm hiện nay nhé!
      </p>
      ...
      <div className="mt-1">
        ...
        <p>
          ...
          thật. Họ có gương mặt, phong cách hoặc giọng nói mô phỏng từ phiên bản
          ngoài đời.
        </p>
      ...
      <div className="mt-2.5">
        ...
        <p>
          FVI là thần tượng ảo hoàn toàn hư cấu, không đại diện cho người thật.
          Ngoại hình, tính cách, giọng nói và hành vi của họ được tạo ra bằng
          công nghệ như AI và đồ họa máy tính. FVI tồn tại độc lập như một thực
          thể kỹ thuật số.
        </p>
        <div className="flex flex-wrap justify-center text-center gap-2 mt-2.5">
          <div>
