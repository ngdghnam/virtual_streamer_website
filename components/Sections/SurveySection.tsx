...
const putData = {
  ...
  responses: {
    ...
    pre_general_1: ["ae của aespa (CVA)", "Hatsune Miku (FVI)", "K/DA (FVI)"],
    ...
    oe_cva_1: "Cũng cũng",
    ai_oe_cva_1:
      "Trong suy nghĩ của bạn, điều gì khiến một Celeb Virtual Avatar trở nên hấp dẫn hoặc dễ tạo thiện cảm hơn? Bạn có thể cho ví dụ cụ thể được không?",
    extra_oe_cva_1:
      "Tôi cảm thấy CVA dễ tạo thiện cảm vì họ mang hình ảnh của người nổi tiếng thật mà tôi yêu thích, nên cảm giác rất gần gũi và chân thật.",
